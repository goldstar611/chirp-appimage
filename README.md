...
```
Installing collected packages: pyyaml, prompt_toolkit, docker, decorator, contextlib2, schema, questionary, pyaml, jsonpath-rw, emrichen, appimage-builder
...
```
and you're done. You will find `Chirp-0.1.0-x86_64.AppImage` in your directory after the command finishes.
